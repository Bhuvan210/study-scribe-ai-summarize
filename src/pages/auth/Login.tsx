  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-gray-100 bg-slate-800 text-white">
          ...
          <CardContent className="space-y-6">
            <Button 
              ...
              variant="outline" 
              className="w-full h-12 bg-white text-gray-900 border-gray-300 hover:bg-gray-50"
            >
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          disabled={isLoading}
                          className="bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus-visible:ring-indigo-500"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
