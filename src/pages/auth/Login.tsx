      ...
      <div className="w-full max-w-md">
        <div className="mb-8 flex justify-center">
          <Link to="/" className="flex items-center">
            <BookOpen className="h-8 w-8 text-study-600 dark:text-study-400" />
            <span className="ml-2 text-2xl font-bold text-study-800 dark:text-study-200">
              StudyScribe
            </span>
          </Link>
        </div>
        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardHeader>
            <CardTitle className="dark:text-white">Log in</CardTitle>
          ...
          <CardFooter className="flex flex-col space-y-2">
            <div className="text-sm text-gray-500 dark:text-gray-400">
              <Link
                to="/forgot-password"
                className="text-study-600 hover:text-study-800 dark:text-study-400 dark:hover:text-study-300"
              >
